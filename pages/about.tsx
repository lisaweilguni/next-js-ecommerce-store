      ...
      <div css={mainStyles}>
        ...
        <div css={contentSectionStyles}>
          <div css={textSectionStyles}>
            <h1>About</h1>
            <div>
              cycleria is a fictional online shop for vintage road bicycles.
              Lisa is a passionate cyclist with a special love for vintage road
              bikes. You might catch me cruising through the streets of Vienna
              on my retro Puch bike or cycling through the forest with my
              recently acquired gravel bike.
            </div>
            <div>
              This application was built from scratch for learning purposes. It
              was created using Next.js, JavaScript, CSS3, HTML5, Node.js,
              React.js, PostgreSQL, TypeScript, Playwright and Jest.
            </div>
          </div>
        </div>
      </div>
